...
export default function AddCategoryModal({
  ...
  const HandleSubmitRegister = async () => {
    ...
    const request = {
      ...
      categoryDescription: inputCategory.categoryDescription,
    };
    try {
  ...
  const HandleSubmitEdit = async () => {
    ...
    const request = {
      id: selectedId.id,
      categoryName: inputCategory.categoryName.trim(),
    };
    if (inputCategory.categoryDescription.trim() !== "")
      request.categoryDescription = inputCategory.categoryDescription.trim();
    try {
  ...
  return (
    ...
    >
      <div className="overflow-auto max-h-[calc(100vh-200px)] 2xl:max-h-[calc(100vh-300px)]">
        {/* show all category */}
