  ...
  return (
    <AnimatePresence>
      {openBatchContol && (
        ...
        >
          {/* Card */}
          <div className="relative w-80 h-20 flex justify-center items-center mb-13 2xl:mb-5  gap-3 bg-[#FCF2FF] rounded-2xl border border-gray-400 shadow-md shadow-gray-500 pointer-events-auto">
            {/* Count bubble */}
