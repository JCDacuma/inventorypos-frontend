...
export default function BatchControl({ children, Count }) {
  return (
    <>
      ...
      >
        <div className=" relative w-80 h-20 flex justify-center items-center mb-3 gap-3 bg-[#FCF2FF] p-5 rounded-2xl pointer-events-auto border-[0.1rem] border-gray-400">
