  ...
  return (
    ...
    >
        <MainWrapper mainStyle="p-10">
          ...
          {status.message && <Status type ={status.type} message={status.message}/>}

            <Row>
              <Col>
                 <label className="w-32 text-sm font-medium text-slate-700">First Name</label>
                  <Input
                    type="text"
            ...
            <Row>
              <Col>
                <label className="mb-1 text-sm font-medium text-slate-700 ms-2">Username</label>
        ...
        <Row>
              ...
              <div className="inline-flex rounded-2xl border border-slate-200 bg-white shadow-sm p-3">
                ...
                />
                <span className="text-sm text-slate-700">Register user as Admin</span>
              </div>
              </Col>
              ...
              <Col className="inline-flex items-center space-x-2">
                <div className="inline-flex rounded-2xl border border-slate-200 bg-white shadow-sm p-3">
                  <input
                    ...
                    className="h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-2 me-3"
                  />
                  <span className="text-sm text-slate-700">Can edit item details</span>
                </div>
              </Col>
              ...
              <Col className="inline-flex items-center space-x-2">
                <div className="inline-flex rounded-2xl border border-slate-200 bg-white shadow-sm p-3">
                  <input
                    ...
                    className="h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-2 me-3"
                  />
                  <span className="text-sm text-slate-700">Can edit item stocks</span>
                </div>
              </Col>
            ...
            <Row>
              ...
              <Col>
                <label className="mb-1 text-sm font-medium text-slate-700 ms-2">Confirm Password</label>
